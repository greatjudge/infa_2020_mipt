...
def draw_tree(screen, tree_coords, tree_trunk_params, tree_crown_params):
    ...
    crown_radius = tree_crown_params[1] / 5
...
house_one_x = earth_width * 0.2
house_one_y = earth_coords[1] + earth_height / 2

house_one_coords = (house_one_x, house_one_y)
house_one_height = disp_height * 0.5
house_one_width = house_one_height * 0.8

draw_house(screen, house_one_coords, house_one_width, house_one_height)

house_two_x = earth_width * 0.6
house_two_y = earth_coords[1] + earth_height / 4

house_two_coords = (house_two_x, house_two_y)
house_two_height = house_one_height * 0.5
house_two_width = house_one_width * 0.5

draw_house(screen, house_two_coords, house_two_width, house_two_height)

# the TREE coordinate is the lowest point in the middle
tree_one_x = house_one_x + house_one_width * 0.8
tree_one_y = house_one_y

tree_one_coords = (tree_one_x, tree_one_y)
tree_one_trunk_height = house_one_height * 0.4
tree_one_trunk_width = house_one_width * 0.09
tree_one_trunk_params = (tree_one_trunk_width, tree_one_trunk_height)

tree_one_crown_height = house_one_height * 0.6
tree_one_crown_width = house_one_width * 0.4
tree_one_crown_color = (0, 100, 0)
tree_one_crown_params = (tree_one_crown_width, tree_one_crown_height, tree_one_crown_color)

draw_tree(screen, tree_one_coords, tree_one_trunk_params, tree_one_crown_params)

tree_two_x = house_two_x + house_two_width * 0.8
tree_two_y = house_two_y

tree_two_coords = (tree_two_x, tree_two_y)
tree_two_trunk_height = house_two_height * 0.4
tree_two_trunk_width = house_two_width * 0.09
tree_two_trunk_params = (tree_two_trunk_width, tree_two_trunk_height)

tree_two_crown_height = house_two_height * 0.6
tree_two_crown_width = house_two_width * 0.4
tree_two_crown_color = (0, 100, 0)
tree_two_crown_params = (tree_two_crown_width, tree_two_crown_height, tree_two_crown_color)

draw_tree(screen, tree_two_coords, tree_two_trunk_params, tree_two_crown_params)
...
cloud_one_y = sky_height * 0.25
cloud_one_x = sky_width * 0.1
cloud_one_coords = (cloud_one_x, cloud_one_y)
cloud_one_radius = math.sqrt((disp_width * 0.025) ** 2 + (disp_height * 0.025) ** 2)
draw_cloud(screen, cloud_color, cloud_one_coords, cloud_one_radius)

cloud_two_y = sky_height * 0.5
cloud_two_x = sky_width * 0.5
cloud_two_coords = (cloud_two_x, cloud_two_y)
cloud_two_radius = math.sqrt((disp_width * 0.03) ** 2 + (disp_height * 0.03) ** 2)
draw_cloud(screen, cloud_color, cloud_two_coords, cloud_two_radius)

cloud_three_y = sky_height * 0.6
cloud_three_x = sky_width * 0.8
cloud_three_coords = (cloud_three_x, cloud_three_y)
cloud_three_radius = math.sqrt((disp_width * 0.02) ** 2 + (disp_height * 0.02) ** 2)
draw_cloud(screen, cloud_color, cloud_three_coords, cloud_three_radius)
